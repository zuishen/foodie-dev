...
import work.jimmmy.foodie.resource.FileUpload;
...
public class CenterUserController extends BaseController {
    ...
    @PostMapping("update")
    public JsonResultResponse update(
        ...
        // TODO: 后续修改，增加令牌token，会整合进redis，分布式会话
    ...
    public JsonResultResponse update(
        ...
        if (file != null) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(fileName)) {
                    ...
                    !suffix.equalsIgnoreCase("jpg") &&
                        ...
                        return JsonResultResponse.errorMsg("图片格式不正确");
                    }
            ...
            return JsonResultResponse.errorMsg("文件不能为空");
        }
